...
class YOLODataPrep:
    ...
    def prepare_data(self, split = {'train':0.7, 'validate':0.2, 'test':0.1}):
        ...
        if len(validate)>0:
            for val_image_file in validate:
